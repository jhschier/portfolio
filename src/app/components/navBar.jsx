  ...
  return (
    <div className="flex h-full items-center justify-between px-4 text-xl sm:px-8 md:px-12 lg:px-20 xl:px-48">
      ...
      <div className="md:hidden lg:flex xl:w-1/3 xl:justify-center">
        ...
        >
          <span className="mr-1 text-white">JoJo</span>
      ...
      <div className="hidden w-1/3 justify-end gap-4 md:flex">
        <Link href="https://github.com/jhschier">
          <Image src="/github.png" alt="" width={24} height={24} />
        </Link>

        <Link href="https://www.instagram.com/jhschier/">
          <Image src="/instagram.png" alt="" width={24} height={24} />
        </Link>

        <Link href="https://www.linkedin.com/in/joao-schier/">
